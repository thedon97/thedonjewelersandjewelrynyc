...
const products = [
  ...
  },
  {
    ...
    price: 2300,
    estimate: 2300,
    priceLabel: "Starting at $2,300",
    image: "teal-marquise-diamond-cluster-ring.jpeg",
    alt: "Teal marquise center stone ring with pear diamond side clusters",
    lede: "A bold teal marquise lab-grown diamond center stone framed by pear diamond cluster accents. Pricing starts at $2,300 for 1 carat and scales through 6 carats with selected metal, gold weight, and ring size.",
    cta: "Message Us for Custom Azure Marquise Cluster Ring",
    badges: ["Lab-Grown Diamond", "Marquise Cut", "Diamond Accents", "Made to Order"],
    fields: [["Center Stone Size", azureClusterCarats], ["Center Stone", ["Teal marquise lab-grown diamond", "Blue lab-grown diamond", "Green lab-grown diamond"]], ["Side Stones", ["Pear diamond clusters"]], ["Diamond Type", ["Lab-Grown Diamond"]], ["Metal", metals], ["Ring Size", ringSizes], ["Specification Note", ["Weight varies. Request weight details."]]],
  },
  {
    id: "celeste-halo",
    category: "Earrings",
  ...
  },
  {
    ...
    category: "Wedding Bands",
    name: "Aurora Round Diamond Wedding Bands",
    price: 1300,
    estimate: 1300,
    priceLabel: "Starting at $1,300",
    image: "round-diamond-huggie-earrings.jpeg",
    alt: "Yellow gold round diamond wedding bands on a black luxury background",
    lede: "A made-to-order pair of round diamond wedding bands with polished gold centers and diamond-set borders. Select metal and diamond coverage for a custom pair.",
    cta: "Message Us for Custom Diamond Wedding Bands",
    badges: ["Wedding Bands", "Made to Order", "14K / 18K / Platinum", "Financing Available"],
    fields: [["Diamond Coverage", ["Classic diamond border", "Full diamond border", "Wide diamond border"]], ["Diamond Type", ["Lab-Grown Diamond", "Natural Diamond"]], ["Metal", gold14And18PlatinumMetals(1300, 1600, 1950)], ["Band Set", ["Pair of wedding bands"]], ["Specification Note", ["Weight varies. Request weight details."]]],
  },
  ...premiumStudProducts,
  {
    id: "marquise-arc",
  ...
  },
  {
    ...
    alt: "Silver rosary necklace with crucifix detail",
    lede: "Silver rosary necklace with faceted bead stations and crucifix detail. Final pricing varies by metal, bead quality, chain length, and custom finish.",
    ...
    fields: [["Metal", ["Sterling Silver", "14K White Gold by request", "14K Yellow Gold by request"]], ["Bead Detail", ["Faceted silver-tone beads", "Gemstone beads by request"]], ["Necklace Length", ["Custom length"]], ["Production", ["Made to Order"]], ["Specification Note", ["Weight varies. Request weight details."]]],
  },
  {
